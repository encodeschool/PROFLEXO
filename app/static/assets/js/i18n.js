 	...
 	"header": {
    	...
    	"hero": {
		 "goBack": {
    		...
    		"title": {
      		"uz": "Sizning muvaffaqiyatingiz bizning qadoqda!",
          "ru": "Ваш успех в нашей упаковке!",
          "en": "Your success in our packaging!"
    		},
    		"description": {
      		"uz": "Biz eng aqlli insonlarni va ilg‘ortexnologiyalarni birlashtirib, kelajakning qadoqlashmahsulotlarini yaratamiz. Maqsadimiz — xodimlarnirivojlantirish, ishlab chiqarish va ekologiyagag‘amxo‘rlik qilishda mukammallik orqali MarkaziyOsiyoda yetakchi kompaniyaga aylanish, vamijozlarimiz kutganidan ham yaxshirog'ini berish.",
          "ru": "Мы создаем упаковку будущего, объединяя лучшие умы и передовые технологии. Наша цель — стать ведущей компанией в Центральной Азии через совершенство в развитии сотрудников, производстве и заботе об экологии, превосходя ожидания наших клиентов.",
          "en": "We create the packaging of the future, bringing together the best minds and cutting-edge technologies. Our goal is to become a leading company in Central Asia through excellence in employee development, production, and environmental stewardship, while exceeding our customers' expectations."
    		},
    		"familiarize": {
      		"uz": "Tanishmoq",
          "ru": "Ознакомиться",
  		...
  		"departments": {
  			...
  			"package4": {
  				...
  				"ru": "Упаковка для круп, макаронных изделий, соли, сахара и других бакалейных изделий",
  			...
  			"package13": {
  				...
  				"ru": "Упаковка для гигиенических изделий",
  			...
  			"package2_des_what1": {
  				"uz": "<li>\n" +
					"                       <p>Kichik paketlar yoki tayoqchalar ko'rinishidagi paketlar. Ushbu turdagi qadoqlash bir martalik mahsulotlar uchun idealdir. U deyarli har qanday quruq tarkibni qadoqlash uchun ishlatiladi - shakardan tortib dongacha (bunday choy qadoqlariga misollar).</p>\n" +
					"                     </li>\n" +
					"                     <li>\n" +
  				...
  				"ru": "<li>\n" +
					...
					"                    </li>",
  				"en": "<li>\n" +
					"                       <p>Packages in the form of small sachets or sticks. This type of packaging is ideal for single-serving products. It is used for packaging almost any dry content - from sugar to cereals (examples of such tea packaging).</p>\n" +
					"                     </li>\n" +
					"                     <li>\n" +
  		...
  		"footer": {
			...
			"call": {
				  "ru": "Не нашли свой вид упаковки, свяжитесь с нами, и наши технологи подберут подходящий для вас упаковку. <a href=\"#contact\">Связаться</a>",
				  "en": "If you haven’t found your type of packaging, contact us and our technologists will select the appropriate packaging for you. <a href=\"#contact\">Get in touch</a>",
				  "uz": "Agar siz o'zingizning qadoqlash turini topmagan bo'lsangiz, biz bilan bog'laning va bizning texnologlarimiz siz uchun mos qadoqni tanlaydi. <a href=\"#contact\">Aloqaga chiqish</a>",
			}
        ...
        "description": {
	  	...
	  	"post": {
			...
			"subtitle": {
				...
				"uz": "Moslik sertifikati"
			},
			"description": {
				"ru": "Производство полимерных пленок методом выдувной экструзии;Гибкой упаковки для пищевой продукции из полимерной пленки, метализированной пленки, бумаги, фольги, а также их комбинаций, с печатью или без печати, в рулонах или в виде готовой упаковки.",
				"en": "Production of polymer films by blown extrusion; Flexible packaging for food products made of polymer film, metallized film, paper, foil, as well as their combinations, printed or unprinted, in rolls or as finished packaging.",
				"uz": "Polimer plyonkalarni puflab ekstrudatsiya qilish usuli bilan ishlab chiqarish; oziq-ovqat mahsulotlari uchun polimer plyonka, metallizatsiyalangan plyonka, qog'oz, folga va ularning kombinatsiyalaridan tayyorlangan moslashuvchan qadoqlash, bosilgan yoki bosilmagan, rulonlarda yoki tayyor qadoq shaklida."
			},
			"download": {
				"ru": "Скачать",
				"en": "Download",
